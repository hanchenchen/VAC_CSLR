...
def get_parser():
    ...
    parser.add_argument(
        "--dataset-info", default=dict(), help="data loader will be used"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--decode-mode", default="max", help="search mode for decode, max or beam"
    )
    parser.add_argument(
        "--ignore-weights",
        type=str,
    ...
    parser.add_argument(
        "--loss-weights", default=default_loss_dict, help="loss selection"
    )
