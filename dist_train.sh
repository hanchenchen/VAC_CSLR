CUDA_VISIBLE_DEVICES=0,3 nohup python -m torch.distributed.launch \
--nproc_per_node=2 --master_port=3465 main.py  \
--config configs/1002-02-conv-ctc-00.yaml  \
--device 0,1 \
--batch-size 1 \
--work-dir work-dir/dist-gpu=2xbs=1-train/1021-24-proposal_num=32-22/  & \
