CUDA_VISIBLE_DEVICES=2,4 nohup python -m torch.distributed.launch \
--nproc_per_node=2 --master_port=3597 main.py  \
--config configs/1002-02-conv-ctc-00.yaml  \
--device 0,1 \
--batch-size 1 \
--work-dir work-dir/dist-gpu=2xbs=1-train/1018-04-residual-branch-01/  & \
